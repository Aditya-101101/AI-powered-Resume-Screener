...
const RecruiterSignUp = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const response = await api.post('/recruiter/signup', recruiterData)
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          ...
          <span> | Register as a
            <Link to="/user-register">
              <span className='pl-1 font-medium text-indigo-500 hover:underline hover:cursor-pointer'>Applicant</span>
            </Link>
          </span>
        </p>
      </div>
